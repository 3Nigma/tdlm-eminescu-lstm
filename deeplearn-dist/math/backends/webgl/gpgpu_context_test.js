...
test_util.describeCustom('GPGPUContext .downloadMatrixFromTexture', function () {
    var gpgpu;
    var texture;
    beforeEach(function () {
...
test_util.describeCustom('GPGPUContext color texture with float textures', function () {
    var gpgpu;
    var texture;
    afterEach(function () {
        gpgpu.deleteMatrixTexture(texture);
...
test_util.describeCustom('GPGPUContext color texture with byte packing', function () {
    var gpgpu;
    var texture;
    afterEach(function () {
        gpgpu.deleteMatrixTexture(texture);
...
test_util.describeCustom('GPGPUContext setOutputMatrixTexture', function () {
    var gpgpu;
    var texture;
    beforeEach(function () {
        gpgpu = new gpgpu_context_1.GPGPUContext();
...
describe('GPGPUContext setOutputPackedMatrixTexture', function () {
    var gpgpu;
    var texture;
    beforeEach(function () {
        gpgpu = new gpgpu_context_1.GPGPUContext();
...
describe('GPGPUContext setOutputMatrixWriteRegion', function () {
    var gpgpu;
    var program;
    var output;
    beforeEach(function () {
...
describe('GPGPUContext', function () {
    var gpgpu;
    beforeEach(function () {
        gpgpu = new gpgpu_context_1.GPGPUContext();
        gpgpu.enableAutomaticDebugValidation(true);
