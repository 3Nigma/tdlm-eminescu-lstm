...
describe('mulmat_packed_gpu (multiple matrices)', function () {
    it('4x2 * 2x12 * 12x1 === 4x1', function () {
        ...
        var axbProgram = gpgpu.createProgram(mulmat_packed_gpu.getFragmentShaderSource(2, matmul_1.MatrixOrientation.REGULAR, matmul_1.MatrixOrientation.REGULAR));
        var abxcProgram = gpgpu.createProgram(mulmat_packed_gpu.getFragmentShaderSource(12, matmul_1.MatrixOrientation.REGULAR, matmul_1.MatrixOrientation.REGULAR));
...
describe('mulmat_packed_gpu A * B^t', function () {
    it('1x1 * 1x1', function () {
        ...
        var result = mulmat_packed_gpu.uploadMultiplyMatrixPackedDownload(a, [1, 1], b, [1, 1], matmul_1.MatrixOrientation.REGULAR, matmul_1.MatrixOrientation.TRANSPOSED);
        expect(result[0]).toEqual(6);
    });
    it('2x2 * 2x2', function () {
        var a = new Float32Array([1, 2, 3, 4]);
        var b = new Float32Array([5, 6, 7, 8]);
        var result = mulmat_packed_gpu.uploadMultiplyMatrixPackedDownload(a, [2, 2], b, [2, 2], matmul_1.MatrixOrientation.REGULAR, matmul_1.MatrixOrientation.TRANSPOSED);
    ...
    it('2x4 * 4x2', function () {
        ...
        var result = mulmat_packed_gpu.uploadMultiplyMatrixPackedDownload(a, [2, 4], b, [2, 4], matmul_1.MatrixOrientation.REGULAR, matmul_1.MatrixOrientation.TRANSPOSED);
...
describe('mulmat_packed_gpu (transposed versions)', function () {
    it('A * B^t', function () {
        ...
        var c = mulmat_packed_gpu.uploadMultiplyMatrixPackedDownload(a, [2, 3], b, [2, 3], matmul_1.MatrixOrientation.REGULAR, matmul_1.MatrixOrientation.TRANSPOSED);
    ...
    it('A^t * B', function () {
        var a = new Float32Array([1, 2, 3, 4, 5, 6]);
        var b = new Float32Array([1, 0, 2, 4, 3, 0]);
        var c = mulmat_packed_gpu.uploadMultiplyMatrixPackedDownload(a, [2, 3], b, [2, 3], matmul_1.MatrixOrientation.TRANSPOSED, matmul_1.MatrixOrientation.REGULAR);
    ...
    it('A^t * B^t', function () {
        var a = new Float32Array([1, 2, 3, 4, 5, 6]);
        var b = new Float32Array([1, 0, 2, 4, 3, 0]);
        var c = mulmat_packed_gpu.uploadMultiplyMatrixPackedDownload(a, [3, 2], b, [2, 3], matmul_1.MatrixOrientation.TRANSPOSED, matmul_1.MatrixOrientation.TRANSPOSED);
