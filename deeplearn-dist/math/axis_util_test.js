...
describe('axis_util parseAxisParam', function () {
    ...
    it('axis=null returns 0 axis for array1d', function () {
        var axis = null;
        var shape = [4];
        expect(axis_util.parseAxisParam(axis, shape)).toEqual([0]);
    });
    it('axis=null returns all axes for array3d', function () {
        var axis = null;
        var shape = [3, 1, 2];
...
describe('axis_util getUndoAxesPermutation', function () {
    it('4d axes', function () {
        var axes = [2, 0, 1, 3];
    ...
    it('4d array with values', function () {
        ...
        var a = dl.randNormal([2, 3, 4, 5]);
        var aT = environment_1.ENV.math.transpose(a, axes);
        var aTT = environment_1.ENV.math.transpose(aT, undoPermutation);
